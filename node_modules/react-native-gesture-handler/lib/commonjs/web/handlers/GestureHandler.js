...
class GestureHandler {
  ...
  moveToState(newState, sendIfDisabled) {
    ...
    if (this.tracker.getTrackedPointersCount() > 0 && this.config.needsPointerData && (newState === _State.State.END || newState === _State.State.CANCELLED || newState === _State.State.FAILED)) {
      this.cancelTouches();
    }
